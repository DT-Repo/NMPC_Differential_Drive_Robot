...
figure
subplot(221)
stairs(t,u_cl(:,1),'k','linewidth',1.5); axis([0 t(end) -0.5 0.8])
ylabel('v (m/s)')
xlabel('time (seconds)')
grid on
subplot(222)
...
stairs(t,omega_R,'k','linewidth',1.5); axis([0 t(end) 0 5])
ylabel('\omega_R (rad/s)')
xlabel('time (seconds)')
grid on
subplot(224)
omega_L = (u_cl(:,1) - u_cl(:,2)*(d/2))/r;
stairs(t,omega_L,'k','linewidth',1.5); axis([0 t(end) 0 5])
