...
#define CASADI_GIT_REVISION "58aa427bc7ed85d7cacfaf7c123f4eaca13a2d35"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.3.0-279.58aa427bc"  // NOLINT(whitespace/line_length)
